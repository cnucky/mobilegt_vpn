...
${OBJECTDIR}/cacheLogger.o: cacheLogger.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cacheLogger.o cacheLogger.cpp
...
${OBJECTDIR}/cacheLogger_nomain.o: ${OBJECTDIR}/cacheLogger.o cacheLogger.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cacheLogger_nomain.o cacheLogger.cpp;\
	else  \
