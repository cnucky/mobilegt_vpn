...
${OBJECTDIR}/mobilegt_TunDataProcess.o: mobilegt_TunDataProcess.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mobilegt_TunDataProcess.o mobilegt_TunDataProcess.cpp

${OBJECTDIR}/mobilegt_TunReceiver.o: mobilegt_TunReceiver.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mobilegt_TunReceiver.o mobilegt_TunReceiver.cpp

${OBJECTDIR}/mobilegt_TunnelConnectChecker.o: mobilegt_TunnelConnectChecker.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mobilegt_TunnelConnectChecker.o mobilegt_TunnelConnectChecker.cpp

${OBJECTDIR}/mobilegt_TunnelDataProcess.o: mobilegt_TunnelDataProcess.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mobilegt_TunnelDataProcess.o mobilegt_TunnelDataProcess.cpp

${OBJECTDIR}/mobilegt_TunnelReceiver.o: mobilegt_TunnelReceiver.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mobilegt_TunnelReceiver.o mobilegt_TunnelReceiver.cpp

${OBJECTDIR}/mobilegt_util.o: mobilegt_util.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mobilegt_util.o mobilegt_util.cpp

${OBJECTDIR}/mobilegt_vpnserver.o: mobilegt_vpnserver.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mobilegt_vpnserver.o mobilegt_vpnserver.cpp
...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/tests/get_config_simpletest.o ${OBJECTFILES:%.o=%_nomain.o}
	...
	${LINK.cc} -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS}  -lcryptopp 
...
${OBJECTDIR}/mobilegt_TunDataProcess_nomain.o: ${OBJECTDIR}/mobilegt_TunDataProcess.o mobilegt_TunDataProcess.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mobilegt_TunDataProcess_nomain.o mobilegt_TunDataProcess.cpp;\
	else  \
...
${OBJECTDIR}/mobilegt_TunReceiver_nomain.o: ${OBJECTDIR}/mobilegt_TunReceiver.o mobilegt_TunReceiver.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mobilegt_TunReceiver_nomain.o mobilegt_TunReceiver.cpp;\
	else  \
...
${OBJECTDIR}/mobilegt_TunnelConnectChecker_nomain.o: ${OBJECTDIR}/mobilegt_TunnelConnectChecker.o mobilegt_TunnelConnectChecker.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mobilegt_TunnelConnectChecker_nomain.o mobilegt_TunnelConnectChecker.cpp;\
	else  \
...
${OBJECTDIR}/mobilegt_TunnelDataProcess_nomain.o: ${OBJECTDIR}/mobilegt_TunnelDataProcess.o mobilegt_TunnelDataProcess.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mobilegt_TunnelDataProcess_nomain.o mobilegt_TunnelDataProcess.cpp;\
	else  \
...
${OBJECTDIR}/mobilegt_TunnelReceiver_nomain.o: ${OBJECTDIR}/mobilegt_TunnelReceiver.o mobilegt_TunnelReceiver.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mobilegt_TunnelReceiver_nomain.o mobilegt_TunnelReceiver.cpp;\
	else  \
...
${OBJECTDIR}/mobilegt_util_nomain.o: ${OBJECTDIR}/mobilegt_util.o mobilegt_util.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mobilegt_util_nomain.o mobilegt_util.cpp;\
	else  \
...
${OBJECTDIR}/mobilegt_vpnserver_nomain.o: ${OBJECTDIR}/mobilegt_vpnserver.o mobilegt_vpnserver.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mobilegt_vpnserver_nomain.o mobilegt_vpnserver.cpp;\
	else  \
